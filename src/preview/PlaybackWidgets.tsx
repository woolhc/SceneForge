  ...
  return (
    <div
      ...
      style={{
        ...
        background: s?.decorationBackground ?? (bgColor === "none" ? "transparent" : bgColor),
        padding: s?.decorationPadding ?? (bgColor === "none" ? "4px 10px" : `${bgPadding * fontScale}px ${bgPadding * 2 * fontScale}px`),
        borderRadius: s?.decorationBorderRadius ?? (bgColor === "none" ? 0 : 4),
        boxShadow: s?.decorationBoxShadow ?? undefined,
        textAlign: "center",
        whiteSpace: "pre-wrap",
        maxWidth: "86%",
        zIndex: 7,
